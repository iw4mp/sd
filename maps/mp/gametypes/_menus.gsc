...
getTeamAssignment()
{
	...
	// Always balance by live player count. Stock behavior trusted
	// self.sessionteam (set natively, pre-GSC) whenever it was already
	// non-"none"/"spectator" and the player wasn't currently playing/dead -
	// that's meant for a real matchmaking lobby that pre-assigns teams.
	// This build's Steam connect flow has no team-select screen and no
